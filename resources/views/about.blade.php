  ...
  <main class="main">
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>About Us</h2>
        <p>Information technology is a system capable of providing added value to an organization or an individual.
          In the current era of digitalization, PT Fasya Pratama Solusindo is here to provide information 
          technology-based services with experienced experts and professional system design and development capabilities.</p>
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              <div class="img">
                <img src="assets/img/gambar_It_konsultan.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                ...
                <p>The importance of good design defines a product with a good level of efficiency and
                  accuracy. With the use of methods in developing the system, creating products according 
                  to customer needs.</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item">
              <div class="img">
                <img src="assets/img/gambar_It_development.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                ...
                <a href="service-details.html" class="stretched-link">
                  <h3>IT Developments</h3>
                </a>
                <p>Enterprise Resource Planning (ERP)
                  An application system that includes all
                  functions and business processes in an
                  organization. With the implementation of
                  an ERP system the company is able to
                  improve business processes which have a
                  direct impact on time and budget efficiency.</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="700">
            <div class="service-item">
              <div class="img">
                <img src="assets/img/gambar_It_hardware.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                ...
                <p> Provides office equipment such as
                  stationery, access control, video wall, and
    ...
    <section id="contact" class="contact section">
      ...
      <!--Google Maps Section-->
      <div class="mb-5">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.9918185779475!2d106.92794547399181!3d-6.3950550935954915!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e699569d6e99aad%3A0xa6a6be10f3d271cb!2sRukan%20Food%20Plaza%205%20No.3!5e0!3m2!1sid!2sid!4v1720665592153!5m2!1sid!2sid" style="width: 100%; height: 400px;" src="" frameborder="0" allowfullscreen=""></iframe>
      </div>
      <!-- End Google Maps -->
